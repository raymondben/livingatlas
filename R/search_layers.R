...
#' @examples
#' \dontrun{
#' la_search_layers(type = "all")
#' la_search_layers(type = "grids", query = "park")
#' la_search_layers(type = "shapes", query = "park", output_format = "simple")
#' }
#' @export
la_search_layers <- function(query, type = "all", output_format = "simple") {
    ALA4R::search_layers(query = query, type = type, output_format = output_format)
}
